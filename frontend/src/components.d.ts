...
declare module 'vue' {
  export interface GlobalComponents {
    CanvasContainer: typeof import('./components/CanvasContainer.vue')['default']
    CodeExportDialog: typeof import('./components/CodeExportDialog.vue')['default']
    CustomHtmlLayerNode: typeof import('./components/CustomHtmlLayerNode.vue')['default']
